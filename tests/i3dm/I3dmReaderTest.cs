...
namespace i3dm.tile.tests
{
    public class Tests
    {
        ...
        {
            // arrange
            var i3dmfile = File.OpenRead(@"fixtures/instancedRTC.i3dm");
        ...
        {
            // arrange
            var i3dmfile = File.OpenRead(@"fixtures/instancedAnimated.i3dm");
            Assert.IsTrue(i3dmfile != null);
        ...
        public void InstancedTexturedTest()
        {
            ...
            var i3dmfile = File.OpenRead(@"fixtures/instancedTextured.i3dm");
            Assert.IsTrue(i3dmfile != null);
            // act
            var i3dm = I3dmReader.Read(i3dmfile);
            Assert.IsTrue(expectedMagicHeader == i3dm.I3dmHeader.Magic);
        ...
        public void InstancedBarrelTest()
        {
            ...
            var i3dmfile = File.OpenRead(@"fixtures/barrel.i3dm");
            Assert.IsTrue(i3dmfile != null);
            // act
            var i3dm = I3dmReader.Read(i3dmfile);
            Assert.IsTrue(expectedMagicHeader == i3dm.I3dmHeader.Magic);
            ...
            Assert.IsTrue(i3dm.I3dmHeader.FeatureTableBinaryByteLength == 496);
            Assert.IsTrue(i3dm.I3dmHeader.GltfFormat == 1);
            Assert.IsTrue(i3dm.BatchTableJson.Length >= 0);
            ...
            Assert.IsTrue(i3dm.FeatureTable.BatchIdOffset.componentType== "UNSIGNED_BYTE");

            Assert.IsTrue(i3dm.Positions[0].Equals(new Vector3(0, 0, 0)));
            Assert.IsTrue(i3dm.Positions[1].Equals(new Vector3(20, 0, 0)));
            Assert.IsTrue(i3dm.BatchIds[0]==0);
            Assert.IsTrue(i3dm.BatchIds[1] == 1);
            Assert.IsTrue(i3dm.BatchIds[2] == 2);
            Assert.IsTrue(i3dm.BatchIds[9] == 9);
        ...
        public void InstancedWithBatchTableTest()
        {
            ...
            var i3dmfile = File.OpenRead(@"fixtures/instancedWithBatchTable.i3dm");
            Assert.IsTrue(i3dmfile != null);
            // act
            var i3dm = I3dmReader.Read(i3dmfile);
            Assert.IsTrue(expectedMagicHeader == i3dm.I3dmHeader.Magic);
        ...
        public void InstancedOrientationTest()
        {
            ...
            var i3dmfile = File.OpenRead(@"fixtures/instancedOrientation.i3dm");
            Assert.IsTrue(i3dmfile != null);
            // act
            var i3dm = I3dmReader.Read(i3dmfile);
            Assert.IsTrue(expectedMagicHeader == i3dm.I3dmHeader.Magic);
        ...
        {
            // arrange
            var i3dmfile = File.OpenRead(@"fixtures/tree_billboard.i3dm");
            Assert.IsTrue(i3dmfile != null);
            // act
            var i3dm = I3dmReader.Read(i3dmfile);
            Assert.IsTrue(expectedMagicHeader == i3dm.I3dmHeader.Magic);
            ...
            catch (LinkException le)
            {
                ...
                Assert.IsTrue(le != null);
                Assert.IsTrue(le.Message == "Extensions: KHR_techniques_webgl");
            }
        }
        ...
        {
            // arrange
            var i3dmfile = File.OpenRead(@"fixtures/tree.i3dm");
            Assert.IsTrue(i3dmfile != null);
            // act
            var i3dm = I3dmReader.Read(i3dmfile);
            Assert.IsTrue(expectedMagicHeader == i3dm.I3dmHeader.Magic);
