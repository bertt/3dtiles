...
namespace i3dm.tile.tests
{
    public class I3dmWriterTest
    {
        ...
        {
            var treeGlb = File.ReadAllBytes(@"fixtures/tree.glb");
            var pos1 = new Vector3(100, 101, 102);
            var pos2 = new Vector3(200, 201, 202);
            var positions = new List<Vector3>() { pos1, pos2 };
        ...
        {
            // arrange
            var originalFile = @"fixtures/barrel.i3dm";
        ...
        {
            // arrange
            var i3dmExpectedfile = File.OpenRead(@"fixtures/barrel.i3dm");
        ...
        {
            // arrange
            var i3dmExpectedfile = File.OpenRead(@"fixtures/tree.i3dm");
            var i3dmExpected = I3dmReader.Read(i3dmExpectedfile);
            var positions = i3dmExpected.Positions;
        ...
        {
            var seatGlb = File.ReadAllBytes(@"fixtures/stoel000.glb");
